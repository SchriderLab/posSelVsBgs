...
writeStats(windowedStats, statNames, statFileName)
smallWindowedStats = summStatFuncs.calculateWindowedStats(snpPositions, gameteStrs, L, smallStatNames, numSubWins=1100)
writeStats(smallWindowedStats, smallStatNames, smallStatFileName)
if not fvecFileName.lower() in ["none", "false"]:
    writeFvec(windowedStats, statNames, fvecFileName)
